<%-- 
    ...
    Created on : Apr 17, 2024, 2:37:41 PM
    Author     : Fad Rahmat
--%>
...
<html>
    ...
    <body>
        ...
        <form id='memberFrm' action='memberProcessing.jsp' method='post' onsubmi='return checkICNo()'>
            <fieldset>
                <legend>Member Registration</legend>
                <label for='invoiceno'>Ic No *</label>
                <input type="text" id="icno" name="my_icno" size="15" placeholder="E.g. 92102101245"><br/>
